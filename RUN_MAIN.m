...
colorbar;
subplot(4,2,3);
hist3([find_dist,find_v(:,1)],[50,30]);
subplot(4,2,4);
counts = hist3([find_dist,find_v(:,1)],[50,30]);
imshow(counts,[]);
colormap(hot(256));
colorbar;
subplot(4,2,5);
hist3([find_dist,find_v(:,2)],[50,30]);
subplot(4,2,6);
counts = hist3([find_dist,find_v(:,2)],[50,30]);
imshow(counts,[]);
colormap(hot(256));
colorbar;
subplot(4,2,7);
hist3([find_dist,find_v(:,3)],[50,30]);
subplot(4,2,8);
counts = hist3([find_dist,find_v(:,3)],[50,30]);
imshow(counts,[]);
colormap(hot(256));
colorbar;
...
colorbar;
subplot(4,2,3);
hist3([miss_dist,miss_v(:,1)],[50,30]);
subplot(4,2,4);
counts = hist3([miss_dist,miss_v(:,1)],[50,30]);
imshow(counts,[]);
colormap(hot(256));
colorbar;
subplot(4,2,5);
hist3([miss_dist,miss_v(:,2)],[50,30]);
subplot(4,2,6);
counts = hist3([miss_dist,miss_v(:,2)],[50,30]);
imshow(counts,[]);
colormap(hot(256));
colorbar;
subplot(4,2,7);
hist3([miss_dist,miss_v(:,3)],[50,30]);
subplot(4,2,8);
counts = hist3([miss_dist,miss_v(:,3)],[50,30]);
imshow(counts,[]);
colormap(hot(256));
colorbar;
